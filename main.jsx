...
/**
 * Single-file React site for a handmade products brand.
 * - TailwindCSS styling
 ...
 * 1) Update BRAND, CONTACT_EMAIL, SOCIALS.
 * 2) Replace product images with your own (local / hosted URLs).
 * 3) Deploy as a static site (Vite/Next/CRA) or export to simple HTML bundler.
 */
    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/80 border-b border-amber-100">
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-4">
        ...
        <nav className="ml-auto flex items-center gap-2">
          ...
          <a href="#" className="ml-2 inline-flex items-center gap-2 rounded-xl border px-3 py-2 text-sm hover:bg-amber-50">
...
export default function SiteVitrineAtelier() {
  return (
    <div className="min-h-screen bg-[--bg] text-neutral-900" style={{ ['--bg']: "linear-gradient(180deg, #fff 0%, #fff8e1 60%, #ffffff 100%)" }}>
      <Header />
      <main>
        <Hero />
        <ProductGallery />
